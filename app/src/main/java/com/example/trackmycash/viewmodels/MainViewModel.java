package com.example.trackmycash.viewmodels;
...
public class MainViewModel extends AndroidViewModel {
    ...
    public void getTransactions(Calendar calendar) {
        ...
        if (Constants.SELECTED_TAB == Constants.DAILY) {
            ...
            // Select * from transactions where is = 5
            newTransactions = realm.where(Transaction.class)
                    .greaterThanOrEqualTo("date", calendar.getTime())
                    .lessThan("date", new Date(calendar.getTime().getTime() + (24 * 60 * 60 * 1000)))
                    .findAll();
...
//                .findAll();
    ...
    public void addTransactions(){
        ...
        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE, "Investment", "Card", "Some Note here", new Date(), -900, new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE, "Business", "Other", "Some Note here", new Date(), -1500, new Date().getTime()));
